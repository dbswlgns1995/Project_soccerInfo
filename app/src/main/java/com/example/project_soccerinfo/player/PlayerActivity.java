...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentPagerAdapter = new TeamViewPagerAdapter(getSupportFragmentManager());
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.p_drawer_layout);

        TabLayout tabLayout = findViewById(R.id.p_tab_layout);
        viewPager.setAdapter(fragmentPagerAdapter);
        tabLayout.setupWithViewPager(viewPager);

        NavigationView navigationView = (NavigationView) findViewById(R.id.p_nav_view);
